...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets241C8B3DEABFFBA9B2A08DE0CB581991F0A022B445A93276BB9EF940B69B7534))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySets241C8B3DEABFFBA9B2A08DE0CB581991F0A022B445A93276BB9EF940B69B7534 : System.Data.Mapping.EntityViewContainer
    {

        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySets241C8B3DEABFFBA9B2A08DE0CB581991F0A022B445A93276BB9EF940B69B7534()
        {
            this.EdmEntityContainerName = "SchoolEntities";
            this.StoreEntityContainerName = "SchoolModelStoreContainer";
            this.HashOverMappingClosure = "6ba8411d1dd3e12169446553fdbdb75169b4f5588cd89f391752989af9d6c84c";
            this.HashOverAllExtentViews = "63713b6f2df07a41892cf67881250d82cdfdd4caa4f261857991cbea2acf12c5";
            this.ViewCount = 16;
        }
    ...
    FROM (
        SELECT 
            ...
            T.LastNogWatName AS Person_LastName, 
            T.FirstName AS Person_FirstName, 
            T.HireDate AS Person_HireDate, 
            T.EnrollmentDate AS Person_EnrollmentDate, 
            True AS _from0
    ...
    SELECT VALUE -- Constructing People
        [SchoolModel.Person](T1.Person_PersonID, T1.Person_LastNogWatName, T1.Person_FirstName, T1.Person_HireDate, T1.Person_EnrollmentDate)
    FROM (
        SELECT 
            T.PersonID AS Person_PersonID, 
            T.LastName AS Person_LastNogWatName, 
            T.FirstName AS Person_FirstName, 
            T.HireDate AS Person_HireDate, 
            T.EnrollmentDate AS Person_EnrollmentDate, 
            True AS _from0
